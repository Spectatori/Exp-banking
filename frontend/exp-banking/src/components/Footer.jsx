...
const Footer = () => {
    return (
        <footer className="flex flex-row bg-white w-full h-36 flex-shrink-0 gap-10 max-xl:flex-col max-xl:gap-0 max-xl:w-full  ">
            <img src={logo} alt="logo" className="h-32 pt-5 px-10 pr-12 pointer-events-none" />
            <div className='max-xl:pl-2 flex gap-10'>
                <div className="flex flex-col pt-5 ">
                    <div className="font-mono text-gray-400 text-sm">
                        <p className="text-xl text-gray-500 pointer-events-none">Полезни Връзки</p>
                ...
                <div className="flex flex-col pt-5 max-xl:pl-0">
                    <div className="font-mono text-gray-400 text-sm">
                        <p className="text-xl text-gray-500 pointer-events-none">За нас</p>
                ...
                <div className="flex flex-col pt-5 pl-10 max-xl:pl-0 pointer-events-none">
                    <div className="font-mono text-gray-400 text-sm">
