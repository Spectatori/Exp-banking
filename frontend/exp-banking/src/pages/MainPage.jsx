                ...
                <div className="flex flex-col pl-10 bg-white rounded-b-3xl max-xl:pl-0">
                    <div className="flex flex-row pb-32 pt-32 pl-32 justify-between max-xl:pl-0 max-xl:flex-col max-xl:pt-10 max-xl:items-center max-xl:pb-0">
                        <div className="flex flex-col w-1/4 items-start gap-14 max-2xl:w-1/3 max-xl:items-center max-xl:w-full">
                            <h2 className='text-4xl font-bold text-start max-2xl:text-4xl max-xl:text-3xl max-xl:text-center'>Живей без такси, безплатно откриване и поддръжка на сметки, неограничени безплатни преводи</h2>
                        ...
                        <img src={HappyClient} className='pr-28 pb-20 max-2xl:pr-20 max-2xl:w-3/6 max-2xl:pt-10 max-2xl:h-fit max-xl:w-4/6 max-md:w-full  max-xl:px-10' alt="Happy Client"/>
                    </div>
                </div>

                <div className='flex flex-col pl-30 pb-32 max-2xl:pl-0'>
