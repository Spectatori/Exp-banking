...
export const registerSchema = yup.object().shape({
    ...
    secondname: yup.string()
        .matches(/^[А-Я][а-яА-Я\s-]+$/, 'Презимето трябва да започва с главна буква и да съдържа само букви на кирилица, интервали и тирета.')
        .min(2, 'Името трябва да съдържа поне 2 символа.')
        .max(25, 'Името не може да бъде по-дълго от 25 символа.')
        .required('Името е задължително!'),
    lastname: yup.string()
    ...
    cityName: yup.string()
        ...
        .test('is-valid-city', 'Моля, изберете валиден град.', (value) => {
